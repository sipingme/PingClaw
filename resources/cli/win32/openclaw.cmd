...
if /i "%1"=="update" (
    echo openclaw is managed by PingClaw ^(bundled version^).
    echo.
    echo To update openclaw, update PingClaw:
    echo   Open PingClaw ^> Settings ^> Check for Updates
    echo   Or download the latest version from https://claw.siping.me/
    exit /b 0
)
...
set OPENCLAW_EMBEDDED_IN=PingClaw
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\PingClaw.exe" "%OPENCLAW_ENTRY%" %*
)
