...
describe('plugin installer diagnostics', () => {
  ...
  it('retries once on Windows and logs diagnostic details when bundled copy fails', async () => {
    ...
    const sourceDir = 'C:\\Program Files\\PingClaw\\resources\\openclaw-plugins\\wecom';
    const sourceManifestSuffix = 'Program Files\\PingClaw\\resources\\openclaw-plugins\\wecom\\openclaw.plugin.json';
