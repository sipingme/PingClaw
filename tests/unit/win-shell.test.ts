...
describe('normalizeNodeRequirePathForNodeOptions', () => {
  ...
  it('converts backslashes to forward slashes on Windows', () => {
    setPlatform('win32');
    expect(normalizeNodeRequirePathForNodeOptions('C:\\Users\\70954\\AppData\\Roaming\\pingclaw\\gateway-fetch-preload.cjs'))
      .toBe('C:/Users/70954/AppData/Roaming/pingclaw/gateway-fetch-preload.cjs');
  });
